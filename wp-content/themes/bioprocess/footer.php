                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="footer-widget footer-col-1 mb-50 wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="tp-footer-widget__content mb-10">
                            ...
                            <h4 class="tp-footer-widget__contact mb-20"><a
                                    href="tel:<?= $phone_number;?>"><?= $phone_number;?></a></h4>
                            <small>
                                <i class="bi bi-clock"></i>
                                <?= $office_days ;?> <?= $office_time ;?>
                            </small>
                        </div>
                        <p>At Bioprocess Supplies, we truly understand lab, pilot, and small-scale bioprocess
                            applications.</p>
                        <div class="footer-widget__social">
                            <?php if($facebook){?>
                            <a class="tp-f-fb" href="<?php echo $facebook ;?>" target="_blank"><i
                                    class="fa-brands fa-facebook-f"></i></a>
                            <?php  } ?>

                            <?php if($youtube){?>
                            <a class="tp-f-youtube" href="<?php echo $youtube ;?>" target="_blank"><i
                                    class="fa-brands fa-youtube"></i></a>
                            <?php } ?>

                            <?php if($twitter){?>
                            <a class="tp-f-twitter" href="<?php echo $twitter ;?>" target="_blank"><i
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                    <div class="footer-widget__copyright">
                        <span> Copyright ©<?php echo date('Y') ;?> <a href="<?php echo get_home_url() ;?>">Bioprocess
                                Supplies</a>. <i>All Rights Reserved</i> | Powered by <a href="https://technasurge.com/"
                                target="_blank">technasurge</a></span>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                    <div class="footer-widget__copyright-info info-direction">
                        <ul class="d-flex align-items-center">
                            <li><a href="<?php echo get_home_url() ;?>/terms-and-conditions/">Terms and conditions</a>
                            </li>
                            <li><a href="<?php echo get_home_url() ;?>/privacy-policy/" target="_blank">Privacy
                                    policy</a></li>
                        </ul>
                    </div>
                </div>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.4.1/css/swiper.css"
    integrity="sha512-TX7AnOgJC11oWVj9w9788KVyEO1uVTObzR9EviLvEM6tqjyr05BGq5GqvURQn1lKjlvc04TTPLYo0un6a591tw=="
