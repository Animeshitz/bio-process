            ...
            <div class="row">
                <div class="col-12">
                    <div class="contactform wow fadeInRight p-both" data-wow-delay=".4s">
                        <div class="submit-sketch-content">
                            <p>
                                Do you have a bioprocessing objective for a single-use application, or are you
                                experiencing
                                challenges with your current setup? A fresh perspective from an experienced team can
                                make
                                a significant difference.
                            </p>

                            <p>
                                Whether you’re a returning customer or contacting us for the first time, please complete
                                the form below with details about your application. You may also attach any relevant
                                files.
                                A member of our team will review your submission and follow up within one business day.
                            </p>

                            <p>
                                Please also review the
                                <a href="https://forms.office.com/Pages/DesignPageV2.aspx?subpage=design&FormId=x4Y9I7SjVk2p_hCldRFE4S0uaW2PhvBJuBRJYfOkUKFURjUySzg3NzM1Q1laUFY4MlRST09OSU5ITi4u&Token=526ae789c02a4377af2ab38cbf6dc648"
                                    target="_blank">
                                    BPSSU Design Collaboration Form
                                </a>.
                                Let us know if you have access to this survey.
                            </p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="contactform__input mb-30">
                                        ...
                                        <p class="error-space">
                                            <sapn class="error" id="errorUsername"></sapn>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="contactform__input mb-30">
                                        ...
                                        <p class="error-space">
                                            <sapn class="error" id="errorEmail"></sapn>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="contactform__input mb-30">
                                        ...
                                        <p class="error-space">
                                            <sapn class="error" id="errorPhone"></sapn>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <p class="error-space">
                                        <sapn class="error" id="errorDrawer"></sapn>
                                    </p>
                                </div>
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/jquery.drawr.combined.js">
</script>

<script type="text/javascript">
$("#drawr-container3 .demo-canvas").drawr({
