                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="tp-blog mb-30">
                            ...
                            <div class="tp-blog__thumb p-relative fix">
                                ...
                                <a href="<?php echo get_permalink( $id )?>"><img src="<?php echo $blogs_image ;?>" alt="blog-item"></a>

                                <div class="tp-blog__date text-center">

                                    <h4><?php echo get_the_date( 'd' ); ?><span><?php echo get_the_date( 'M ' ); ?></span></h4>
                            ...
                            <div class="tp-blog__content">
                                ...
                                <h5 class="tp-blog__title mb-20"><a href="<?php echo get_permalink( $id )?>"><?php the_title() ;?></a></h5>
